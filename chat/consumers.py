...
from . mnist_model.recognize_number import recognize_number
...
class ChatConsumer(AsyncWebsocketConsumer):
    ...
    async def receive(self, text_data):
        ...
        if 'image' in text_data_json:
            ...
            recognized_number = recognize_number(image_data)  # Call function here
            
            if recognized_number is not None:
                message = f"The number is: {recognized_number}"
            else:
                message = "Perdon jefe, no pude reconocer el numero"
        else:
            message = text_data_json['message']
